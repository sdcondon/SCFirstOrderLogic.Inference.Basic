...
public class ClauseResolution
{
    ...
    // look at adding a method to Unifier in the core lib that accepts multiple literals and examines the
    // tree for them all "simultaneously" - i.e. do full resolution, not binary.
