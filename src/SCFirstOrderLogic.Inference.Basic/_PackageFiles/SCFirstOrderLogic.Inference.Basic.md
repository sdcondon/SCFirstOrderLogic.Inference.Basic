Very basic first-order logic knowledge base implementations that use the models defined by the [SCFirstOrderLogic package](https://www.nuget.org/packages/SCFirstOrderLogic/).
