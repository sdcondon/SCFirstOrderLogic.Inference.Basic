...
/// <summary>
/// A (rather inefficient) implementation of <see cref="IKnowledgeBaseClauseStore"/> that just uses a hash set to store clauses
...
public class HashSetClauseStore : IKnowledgeBaseClauseStore
{
    ...
    public HashSetClauseStore(IEnumerable<Formula> sentences)
    {
